package develop.ylee.algorithm.algoPlayground.programmers0001
...
class SolutionTest {
    ...
    fun `returns correct order for plans with same times but different durations`() {
        val plans = arrayOf(arrayOf("science", "12:40", "50"), arrayOf("music", "12:20", "40"), arrayOf("history", "14:00", "30"), arrayOf("computer", "12:30", "100"))
